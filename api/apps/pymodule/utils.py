...
keycloak_openid = KeycloakOpenID(server_url="https://auth.douzo.top:8443/",
                                 client_id="flasks",
                                 realm_name="hogepeke",
    ...
    def token(*args, **kwargs):
        ...
        if "X-Access-Token" in request.headers:
            ...
            try:
                ...
                #     algorithms=["RS256"],
                #     audience="flasks",
                #     issuer="https://auth.douzo.top:8443/realms/hogepeke")
                # expireのチェックなども入れる
                ...
                # 'iss': 'https://auth.douzo.top:8443/realms/hogepeke',
                #  'aud': ['flasks', 'account'], 
...
def get_jwt():
    ...
    sub = jwt.decode(
        ...
        algorithms=["RS256"],
        audience="flasks",
        issuer="https://auth.douzo.top:8443/realms/hogepeke")["sub"]
